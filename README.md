...
```
bash <(curl -Ls https://raw.githubusercontent.com/om0504/x-ui/master/install.sh)
```    
For English Users,please use the following command to install English supported version:  
```
bash <(curl -Ls https://raw.githubusercontent.com/om0504/x-ui/master/install_en.sh)
```    
# 效果预览  
`面板使用`:  
<details>
